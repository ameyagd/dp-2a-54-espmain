...
?>
    ...
    <div class="stepFooter">
        <ul class="stepPrev">
            ...
            <li><a href="campaignRecepients.php" class="stepLink">Previous</a></li>
        </ul>
        ...
        <ul class="stepList">
            ...
            <li><a href="campaignCreatives.php" class="stepLink active">Template</a></li>
            <li><i class="fa fa-chevron-right"></i></li>
        ...
        <ul class="stepNext">
            <li><a href="campaignEditMailer.php" class="stepLink">Next</a></li>
            <li><i class="fa fa-chevron-right"></i></li>
        </ul>
    </div>    
</div>
