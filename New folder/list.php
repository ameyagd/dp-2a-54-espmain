...
<input type="hidden" id="listid" value="<?php echo $listid ?>"/>
        <div class="row">
           <div class="col-md-12">
              <h4 id="listtitle" class="listtitle">List Name</h4>
           </div>
        </div>
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="card card-plain mlistbox">
              ...
              <!-- List Statistics graph modal-->
              <div id="myModal" class="modal hide fade graphmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-width="620">
              <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h3 id="myModalLabel">List Statistics</h3>
              </div>
              <div class="modal-body">
              <div id="container" style="min-width: 800px; height: 500px; max-width: 600px; margin: 0 auto"></div>
              </div>
              ...
              <!-- List Statistics graph modal-->
              <div id="myModal2" class="modal hide fade graphmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-width="620">
              <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
              <h3 id="myModalLabel">Overall Lists Statistics</h3>
              </div>
              <div class="modal-body">
              <div id="container" style="min-width: 800px; height: 500px; max-width: 600px; margin: 0 auto"></div>
              </div>
...
$("#overallliststats").click(function(){
    var theModal = $("#myModal2").modal({
        show: false
    });   

    var chart = $('#myModal2 #container').highcharts({
              chart: {
